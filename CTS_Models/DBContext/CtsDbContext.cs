...
namespace CTS_Models.DBContext
{
    public class CtsDbContext : DbContext
	{
        ...
        public virtual DbSet<RailWeighbridges> RailWeighbridges { get; set; }
        public virtual DbSet<CtsUserCtsRoles> CtsUserCtsRole { get; set; }
		...
		public virtual DbSet<BoilerConsNorm> BoilerConsNorm { get; set; }
        public virtual DbSet<BoilerConsNormNews> BoilerConsNormNew { get; set; }
