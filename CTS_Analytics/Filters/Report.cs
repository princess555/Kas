...
{
    public class Report : AuthorizeAttribute
    {
        ...
        protected override bool AuthorizeCore(HttpContextBase httpContext)
        {
            ...
            return httpContext.Request.IsAuthenticated && Role(httpContext) || base.AuthorizeCore(httpContext);
        }
                ...
                try
                {
                    ...
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            ...
                            {
                                if (rolesDB.ToString().ToLower() == allowRole.ToLower().ToString())
                                {
                                    flag = true;
