...
namespace CTS_Analytics.Services
{
    public class WagonDbService
    {
        ...
        /// </summary>
        /// <param name="recognID"></param>
        /// <param name="fromDate"></param>
        /// <param name="toDate"></param>
        /// <returns></returns>
        public IQueryable<RaspoznItem> GetDatesFor(int recognID, DateTime fromDate, DateTime toDate)
        {
            try
            {
                var dbvagonNums = wagdb.vagon_nums
        ...
        //public IQueryable<WagonTransfer> GetDataFromWagonDBWithDate(DateTime fromDate, DateTime toDate, string locationID)
        //{
        //    using (var wagdb = new WagonDBcontext())
        //    {
        //        var vagons = wagdb.ves_vagon.Where(v => v.scales.objects.name == locationID).
        //            Where(t => t.date_time_brutto >= fromDate && t.date_time_brutto <= toDate 
        //            || t.date_time_tara >= fromDate && t.date_time_tara <= toDate).
        //            Select(s => new WagonTransfer()
        //            {
        //                ID = s.id.ToString(),
        //                Brutto = s.ves_brutto / 1000,
        ...
        //            }
        //            );
        //        return vagons.OrderBy(t => t.TransferTimeStamp);
        //    }
        //}
    }
}
