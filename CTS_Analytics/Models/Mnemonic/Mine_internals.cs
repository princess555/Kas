...
namespace CTS_Analytics.Models.Mnemonic
{
	...
	public class Mine_skip : Mine_internals
	{
		...
		public int TotalSkipsPerTimeInterval { get; set; }
	...
	public class Mine_konv : Mine_internals
	{
        ...
        public string BeltKotID{ get; set; }
    ...
    public class Mine_vagon : Mine_internals
	{
        ...
        public float ShippedPerShiftTonns { get; set; } //загружено за смену
        public float ShippedToLastTrainTonns { get; set; } //Загруж. в посл. состав
        public DateTime? ShippedToLastTrainDateTime { get; set; } //Загруж. в посл. состав
        public float LastTrainVagonCount { get; set; } //Кол-во вагонов посл. сос
        public string LastTrainDirection { get; set; } //Направление посл. сост

        public DateTime Time { get; set; } //Загруж. в посл. состав 
        public List<CofvVagons> RailWeigh { get; set; } // Сумма вагонов за период
        public int Count { get; set; }
        
        //public IEnumerable<RailWeighbridges> RailWeighbridgies { get; set; } //кол-во вагонщиков
