...
namespace CTS_Analytics.Controllers
{
    ...
    public partial class MnemonicController : CtsAnalController
    {
        ...
        [MyAuth(Roles = Roles.MineShahRoleName)]
        ...
        [MyAuth(Roles = Roles.MineSar1RoleName)]
        ...
        [MyAuth(Roles = Roles.MineKostRoleName)]
        ...
        [MyAuth(Roles = Roles.MineKuzRoleName)]
        public ActionResult kuz()
        {
            ...
            model.BeltPos44 = Builder.GetBeltScaleModel(2); //Конв.весы поз.501
        ...
        [MyAuth(Roles = Roles.MineTentRoleName)]
        public ActionResult tent()
        {
            ...
            model.Belt = Builder.GetBeltScaleModel(25);
        ...
        [MyAuth(Roles = Roles.MineKazRoleName)]
        ...
        [MyAuth(Roles = Roles.MineSar3RoleName)]
        ...
        [MyAuth(Roles = Roles.MineLenRoleName)]
