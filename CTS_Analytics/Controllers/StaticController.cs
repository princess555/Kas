...
namespace CTS_Analytics.Controllers
{
    ...
    [FilterUsers]
    //[OutputCache(Duration = 60000, Location = OutputCacheLocation.Server)]
    public class StaticController : CtsAnalController
    {
        ...
        [MyAuth(Roles = Roles.GlobalSafetyReportRole)]
        public ActionResult GlobalSafety()
        {
            return View(GetOnlyPeriodsReportModel());
        }

        [MyAuth(Roles = Roles.SiteSafetyReportRole)]
        public ActionResult SiteSafety()
        {
            return View(GetOnlyPeriodsReportModel());
        }

        [MyAuth(Roles = Roles.StockpilesMonthReportRole)]
        public ActionResult StockpilesMonth()
        {
            return View(GetOnlyPeriodsReportModel());
        }

        [MyAuth(Roles = Roles.OverallMineProductionReportRole)]
        public ActionResult OverallProduction()
        {
            return View(GetOnlyPeriodsReportModel());
        }

        [MyAuth(Roles = Roles.ComparisonInfoMiningsReportRole)]
